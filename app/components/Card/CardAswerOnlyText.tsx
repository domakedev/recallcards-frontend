    ...
    <>
      {preview ? (
        ...
        <div className="min-h-[335px] sm:h-[550px] md:h-[610px] bg-gray-800 p-6 flex flex-col gap-2 rounded-xl shadow-xl w-full sm:w-full border-gray-800 border-2">
          ...
          <p className="text-xs sm:text-sm md:text-base flex-1 bg-slate-100 justify-center items-center flex shadow-inner rounded-lg p-4 md:p-8 text-gray-700 font-normal  break-words break-all whitespace-pre-wrap">
            {answer}
          </p>
        </div>
      )}
